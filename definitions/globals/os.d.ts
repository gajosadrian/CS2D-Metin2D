...
declare namespace os {
   ...
   * os.time function for a description of this value). Otherwise, date formats the
   * current time.
   * 
   ...
   * reliance on C function gmtime and C function localtime.
   */
  function date(format: '*t', time?: number): DateInfoResult;
   ...
   * are ignored. For a description of these fields, see the os.date function.
   * 
   ...
   * an argument to os.date and os.difftime.
   */
   ...
   * an argument to os.date and os.difftime.
   */
  function time(table: DateInfo): number;
